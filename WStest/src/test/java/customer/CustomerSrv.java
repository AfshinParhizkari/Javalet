 ...
 * 
 */
@WebServiceClient(name = "CustomerSrv", targetNamespace = "http://Webservice.afshin.com/", wsdlLocation = "http://localhost:8080/order/soap/customer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSRV_QNAME = new QName("http://Webservice.afshin.com/", "CustomerSrv");
    ...
    public CustomerInt getCustomerIntPort() {
        return super.getPort(new QName("http://Webservice.afshin.com/", "CustomerIntPort"), CustomerInt.class);
    }
    ...
    public CustomerInt getCustomerIntPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Webservice.afshin.com/", "CustomerIntPort"), CustomerInt.class, features);
    }
