...
public class ObjectFactory {
    ...
    private final static QName _CustomerXML_QNAME = new QName("http://Webservice.afshin.com/", "CustomerXML");
     ...
     */
    @XmlElementDecl(namespace = "http://Webservice.afshin.com/", name = "CustomerXML")
